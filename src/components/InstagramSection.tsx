        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          ...
          >
            <Link
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-600 text-white rounded-full font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
